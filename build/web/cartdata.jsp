...
<html>
  ...
  <body>
    ...
    <div class="cart-list">
      ...
      <ul >
        <li>
            <p><strong>Product: </strong> <% out.println(namelist.get(i)+"    <strong>Price:</strong> "+pricelist.get(i)+"   <strong>Category:</strong> "+productcategorylist.get(i)); %></p>
          <a href="<% out.println("deleteproduct.jsp?c_id="+c_id+"&uname="+uname);%>">Delete</a>
        </li>
      </ul>
       <%
            }
