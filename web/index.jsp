              ...
              <div class="">
                <div class="col-md-6">
                  ...
                  <ul class="nav flex-column">
                    <li class="nav-item">
                        <a class="nav-link" href="login.html">Men</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="login.html">Women</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="login.html">Kids</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="login.html">Electronics</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="login.html">Furniture</a>
                    </li>
                  </ul>
                </div>
                        ...
                        <div class="owl-item">
                            <div class="bbb_viewed_item d-flex flex-column align-items-center justify-content-center text-center">
                                ...
                                <div class="bbb_viewed_content text-center">
                                    ...
                                    <div class="bbb_viewed_name"><a href="login.html">Alkatel Phone</a></div>
                                </div>
                                <ul class="item_marks">
                        ...
                        <div class="owl-item">
                            <div class="bbb_viewed_item d-flex flex-column align-items-center justify-content-center text-center">
                                ...
                                <div class="bbb_viewed_content text-center">
                                    ...
                                    <div class="bbb_viewed_name"><a href="login.html">Samsung LED</a></div>
                        ...
                        <div class="owl-item">
                            <div class="bbb_viewed_item d-flex flex-column align-items-center justify-content-center text-center">
                                ...
                                <div class="bbb_viewed_content text-center">
                                    ...
                                    <div class="bbb_viewed_name"><a href="login.html">Samsung Mobile</a></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="owl-item">
                            <div class="bbb_viewed_item d-flex flex-column align-items-center justify-content-center text-center">
                                ...
                                <div class="bbb_viewed_content text-center">
                                    ...
                                    <div class="bbb_viewed_name"><a href="login.html">Huawei Power</a></div>
                                </div>
                        ...
                        <div class="owl-item">
                            <div class="bbb_viewed_item d-flex flex-column align-items-center justify-content-center text-center">
                                ...
                                <div class="bbb_viewed_content text-center">
                                    ...
                                    <div class="bbb_viewed_name"><a href="login.html">Speedlink Mobile</a></div>
